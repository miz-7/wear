...
// サイドメニューのコンポーネント
const SideMenu = ({ isOpen, onClose, shops, onShopClick, onOpenNews, onOpenShopList, onOpenGenreFilter}) => {
...
const GenreFilterPanel = ({ isOpen, onClose, selectedGenre, onSelectGenre, shops }) => {
  if (!isOpen) return null;
